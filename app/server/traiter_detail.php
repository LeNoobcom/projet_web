<?php
    ...
    $commentaires = [];
    $query2= "SELECT n.commentaire AS commentaire,n.note AS note, n.iduser AS iduser, u.username AS username, n.idmedia AS idmedia FROM note n JOIN user u ON n.iduser = u.id WHERE n.idmedia=$id AND n.commentaire != '' ORDER BY n.idmedia DESC;";
